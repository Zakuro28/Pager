{{-- Two-panel layout for login, forgot password and reset password. --}}
<!DOCTYPE html>
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .left-quote p { font-size: 0.875rem; color: var(--sub); line-height: 1.6; }
        .left-bottom { font-size: 0.8rem; color: var(--sub); }

        /* ── Right panel ── */
        .right { display: flex; align-items: center; justify-content: center; padding: 2.5rem 3rem; opacity: 0; }
        .form-wrap { width: 100%; max-width: 380px; }
        .form-head { margin-bottom: 2rem; }
        .form-head h1 { font-size: 1.5rem; font-weight: 700; letter-spacing: -0.025em; color: var(--ink); margin-bottom: 0.375rem; }
        .form-head p { font-size: 0.875rem; color: var(--sub); line-height: 1.55; }
        .form-head p a { color: var(--purple); font-weight: 500; text-decoration: none; }
        .form-head p a:hover { text-decoration: underline; }

        /* ── Messages ── */
        .errors { background: var(--error-bg); border: 1px solid var(--error-bdr); border-radius: 8px; padding: 0.75rem 1rem; margin-bottom: 1.25rem; font-size: 0.875rem; color: var(--error); }
        .errors ul { padding-left: 1.1rem; }
        .status { background: var(--ok-bg); border: 1px solid var(--ok-bdr); border-radius: 8px; padding: 0.75rem 1rem; margin-bottom: 1.25rem; font-size: 0.875rem; color: var(--ok); line-height: 1.5; }
        ...
        .check-label { display: flex; align-items: center; gap: 0.5rem; font-size: 0.8125rem; color: var(--sub); cursor: pointer; }
        .check-label input[type="checkbox"] { width: 15px; height: 15px; accent-color: var(--purple); }
        .text-link { font-size: 0.8125rem; font-weight: 500; color: var(--purple); text-decoration: none; }
        .text-link:hover { text-decoration: underline; }

        /* ── Submit ── */
        .btn-submit {
            width: 100%; padding: 0.7rem 1rem;
            background: var(--purple); color: var(--white); border: none; border-radius: 7px;
        ...
        /* ── Back link ── */
        .back { display: inline-flex; align-items: center; gap: 0.3rem; font-size: 0.8rem; color: var(--sub); text-decoration: none; margin-bottom: 2rem; transition: color 0.15s; }
...
<script>
anime({ targets: '#formPanel', opacity: [0, 1], translateX: [24, 0], duration: 700, easing: 'easeOutExpo' });
